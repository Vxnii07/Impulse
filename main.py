...
pygame.display.set_caption("IMPULSE")
clock=pygame.time.Clock()
carimg=pygame.image.load('car1.jpg')
backgroundpic=pygame.image.load("download12.jpg")
yellow_strip=pygame.image.load("yellow strip.jpg")
strip=pygame.image.load("strip.jpg")
intro_background=pygame.image.load("lamborghini_car_sports_car_146392_800x600.jpg")
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("IMPULSE",largetext)
...
def crash():
    pygame.mixer.music.load("car accident.mp3")
